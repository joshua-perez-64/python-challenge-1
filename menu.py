...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            menu_item_number = input("Please select an item number: ")
            ...
            if menu_item_number.isdigit():
                ...
                if menu_item_number in menu_items.keys():
                    ...
                    print("Please pick an item on the menu.")
            else:
    ...
    while True:
        ...
        keep_ordering = input("Would you like to keep ordering? (Y)es or (N)o ").lower().strip()
